...
//  ¿por qué Status dice "Available" si nunca lo asignamos explícitamente en main()? pq en una funcion void esta declarado.
//  el Author no cambió, aunque llamamos setAuthor(""). ¿Por qué? Porque 1r, no tiene nombre y 2ndo, en la funcion void esta que si el string esta vacio, no se cambia.
